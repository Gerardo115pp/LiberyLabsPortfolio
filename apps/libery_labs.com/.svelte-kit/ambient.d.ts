...
declare module '$env/static/private' {
	...
	export const WP_DB_USER: string;
	export const WP_DB_PASSWORD: string;
	...
	export const WP_DB_ROOT_PASSWORD: string;
	...
	export const WP_DB_NAME: string;
